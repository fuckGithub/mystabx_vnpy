...
- **用户体验**：按现代交易台组织流程（连柜台、订阅行情、下单撤单、资金持仓、策略与回测），界面与路径更清晰，减少桌面端多窗口与本机环境摩擦。
- **操作流畅**：Tick 走 WebSocket，账号/资金走 SSE；常用交易与运维动作在浏览器内完成，适合本机或小团队局域网部署。
...
<table width="100%">
  ...
  <tr>
    <td width="50%" valign="top">
      <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/ui-login.png" alt="登录页" width="100%" />
    </td>
    <td width="50%" valign="top">
      <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/ui-workbench.png" alt="工作台" width="100%" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%" valign="top">
      <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/ui-market.png" alt="市场行情" width="100%" />
    </td>
    <td width="50%" valign="top">
      <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/ui-trade.png" alt="交易下单" width="100%" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2">
      <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/ui-strategy-models.png" alt="策略模型" width="100%" />
    </td>
  </tr>
</table>
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/mystabx-zsxq-coupon.png" alt="MyStabx 知识星球新人优惠券" width="360" />
</p>
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/mystabx-wechat-invite-qr.jpg" alt="微信群二维码：MyStabx期货量化交易平台" width="400" />
</p>
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/mystabx-alipay-coffee.jpg" alt="支付宝赞赏码：请作者喝杯咖啡" width="280" />
</p>
...
本项目的**后端并不等于 vn.py**。后端由本仓库自研的 **FastAPI 托管层**（REST / WebSocket / SSE、多用户、通道与策略模型管理、MySQL / ClickHouse 数据层等）组成；其中**交易运行时**依托 [vn.py（VeighNa）](https://www.vnpy.com/)，进程内接入其 `MainEngine`，**不是**把整个后端替换成 vnpy，也**不是**本仓库原创的撮合或柜台协议实现。
...
一句话概括：从「策略想法」到「实盘下单」，在同一套 Web 交易台里打通链路；同时改进体验、操作流畅与 MySQL / ClickHouse 数据治理，而不是只把桌面入口搬到浏览器。
...
技术形态：将 vnpy（VeighNa）从 PySide6 桌面终端做成 **B/S 团队交易终端**（手段），并在其上落地体验、实时链路与双库管控：
...
- 业务 **MySQL** + Tick **ClickHouse**；策略源码/版本与订阅等可入库治理

## 技术架构

![技术架构](https://cdn.jsdelivr.net/gh/fuckGithub/mystabx_vnpy@main/docs/images/architecture.png)
