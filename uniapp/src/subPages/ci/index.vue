  ...
  <view class="min-h-screen bg-gray-100 py-3 dark:bg-[var(--wot-dark-background)]">
    ...
    <view class="mx-3 mb-3">
      <view class="rounded-3 bg-white px-5 py-8 text-center dark:bg-[var(--wot-dark-background2)]">
        ...
        <view class="mb-2 text-6 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">uni-mini-ci</view>
    ...
    <demo-block title="安装方式" transparent>
      <view class="space-y-4">
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          <view class="mb-3 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">全局安装</view>
        ...
        <!-- 局部安装 -->
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          <view class="mb-3 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">局部安装</view>
          <view class="mb-3 text-3 text-gray-600 dark:text-[var(--wot-dark-color2)]">
            在项目中作为开发依赖安装，适合团队协作
          </view>
          <view class="space-y-2">
    ...
    <demo-block title="配置文件" transparent>
      <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        <view class="mb-3 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">.minicirc 配置文件</view>
        <view class="mb-3 text-3 text-gray-600 leading-relaxed dark:text-[var(--wot-dark-color2)]">
          在项目根目录创建
          <text class="rounded bg-gray-100 px-1 font-mono dark:bg-[var(--wot-dark-background3)]">.minicirc</text>
          文件，配置各平台的上传参数
        </view>

        <view
          class="mb-3 border border-gray-200 rounded-2 bg-gray-50 p-3 dark:border-[var(--wot-dark-border)] dark:bg-[var(--wot-dark-background3)]"
          @click="copyCode(configExample)">
          <view class="mb-2 flex items-center justify-between">
            <text class="text-3 text-gray-700 font-bold dark:text-[var(--wot-dark-color)]">配置示例:</text>
            <wd-icon name="copy" size="16px" color="#666" />
          </view>
        ...
        <view class="border border-orange-200 rounded-2 bg-orange-50 p-3 dark:bg-orange-900/20">
          <view class="mb-2 text-3.5 text-orange-700 font-bold dark:text-orange-300">💡 配置说明</view>
    ...
    <demo-block title="添加命令" transparent>
      <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        <view class="mb-3 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">package.json 脚本配置</view>
        <view class="mb-3 text-3 text-gray-600 leading-relaxed dark:text-[var(--wot-dark-color2)]">
        ...
        <view
          ...
          <view class="mb-2 flex items-center justify-between">
            <text class="text-3 text-gray-700 font-bold dark:text-[var(--wot-dark-color)]">脚本配置:</text>
            <wd-icon name="copy" size="16px" color="#666" />
          </view>
          <view class="max-h-60 overflow-y-auto">
            <pre
        ...
        <view class="space-y-2">
          <view class="text-3.5 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">使用命令:</view>
    ...
    <demo-block title="注意事项" transparent>
      <view class="space-y-3">
        <view class="border border-red-200 rounded-2 bg-red-50 p-4 dark:bg-red-900/20">
          <view class="mb-2 text-3.5 text-red-700 font-bold dark:text-red-300">⚠️ 版本号限制</view>
        ...
        <view class="border border-blue-200 rounded-2 bg-blue-50 p-4 dark:bg-blue-900/20">
          <view class="mb-2 text-3.5 text-blue-700 font-bold dark:text-blue-300">💡 最佳实践</view>
        ...
        <view class="border border-green-200 rounded-2 bg-green-50 p-4 dark:bg-green-900/20">
          <view class="mb-2 text-3.5 text-green-700 font-bold dark:text-green-300">🔒 安全建议</view>
    ...
    <demo-block title="相关链接" transparent>
      <wd-cell-group border custom-class="rounded-2! overflow-hidden">
        ...
        <wd-cell
          ...
          value="官方文档"
          is-link
          @click="handleNavigate('https://developers.weixin.qq.com/miniprogram/dev/devtools/ci.html')" />
        <wd-cell
          title="💙 支付宝小程序 CI"
          value="官方文档"
          is-link
