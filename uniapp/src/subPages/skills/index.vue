...
<template>
  <view class="box-border min-h-screen bg-[#f9fafb] pb-safe">
    <!-- Header -->
    <view class="px-6 pb-6 pt-8">
      <view class="mb-2 text-3xl text-gray-900 font-bold leading-tight">Agent Skills</view>
      ...
      <view
        ...
        <view class="flex items-start gap-4">
          ...
          <view
            ...
            <wd-icon :name="skill.icon" size="28px" :color="skill.color" custom-style="display: block;" />
          </view>
