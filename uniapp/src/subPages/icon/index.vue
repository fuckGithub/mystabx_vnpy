  ...
  <view class="min-h-screen bg-gray-100 py-3 dark:bg-[var(--wot-dark-background)]">
    ...
    <view class="mx-3 mb-3">
      <view class="rounded-3 bg-white px-5 py-8 text-center dark:bg-[var(--wot-dark-background2)]">
        ...
        <view class="mb-2 text-6 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">图标使用演示</view>
        <view class="mb-2 text-3.5 text-gray-600 leading-relaxed dark:text-[var(--wot-dark-color2)]">
          WotUI 图标 & Iconify 图标集
        </view>
        <view class="text-3 text-gray-500 dark:text-[var(--wot-dark-color2)]">丰富的图标资源，满足各种使用场景</view>
      </view>
    </view>
    ...
    <demo-block title="图标大小" transparent>
      <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        <view class="mb-3 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">选择图标大小</view>
        ...
        <view
          class="flex items-center justify-center rounded-2 bg-gray-50 p-4 space-x-4 dark:bg-[var(--wot-dark-background3)]">
          ...
          <text class="text-3 text-gray-600 dark:text-[var(--wot-dark-color2)]">当前大小: {{ currentIconSize }}</text>
        </view>
      </view>
    </demo-block>
    ...
    <demo-block title="WotUI 内置图标（精选示例）" transparent>
      ...
      <view class="mt-4 rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        <view class="mb-3 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">使用示例</view>
        <view class="space-y-3">
          <view class="rounded bg-gray-100 p-3 dark:bg-[var(--wot-dark-background3)]">
            <view class="mb-2 text-3 text-gray-700 font-bold dark:text-[var(--wot-dark-color)]">基础用法:</view>
          ...
          <view class="rounded bg-gray-100 p-3 dark:bg-[var(--wot-dark-background3)]">
            <view class="mb-2 text-3 text-gray-700 font-bold dark:text-[var(--wot-dark-color)]">自定义样式:</view>
            <view class="text-2.5 text-gray-600 leading-relaxed font-mono dark:text-[var(--wot-dark-color2)]">
    ...
    <demo-block title="Carbon 图标集" transparent>
      ...
      <view class="grid grid-cols-3 gap-3 md:grid-cols-6 sm:grid-cols-4">
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:add text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">add</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">添加</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:close text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">close</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">关闭</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:checkmark text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">checkmark</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">确认</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:arrow-right text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">arrow-right</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">右箭头</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:home text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">home</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">首页</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:search text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">search</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">搜索</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:star text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">star</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">星级</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:favorite text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">favorite</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">收藏</view>
        </view>
        ...
        <view
          ...
          <view class="mb-2 flex justify-center">
            <view
              class="i-carbon:settings text-gray-600 dark:text-[var(--wot-dark-color)]"
              :style="{ fontSize: currentIconSize }" />
          </view>
          <view class="mb-1 text-2.5 text-gray-800 font-mono dark:text-[var(--wot-dark-color)]">settings</view>
          <view class="text-2 text-gray-500 dark:text-[var(--wot-dark-color2)]">设置</view>
        </view>
      </view>
      ...
      <view class="mt-4 rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        ...
        <view class="space-y-3">
          <view class="rounded bg-gray-100 p-3 dark:bg-[var(--wot-dark-background3)]">
            <view class="mb-2 text-3 text-gray-700 font-bold dark:text-[var(--wot-dark-color)]">UnoCSS 方式:</view>
            <view class="text-2.5 text-gray-600 leading-relaxed font-mono dark:text-[var(--wot-dark-color2)]">
              &lt;div class="i-carbon:star text-xl text-yellow-500"&gt;&lt;/div&gt;
            </view>
          </view>
          <view class="rounded bg-gray-100 p-3 dark:bg-[var(--wot-dark-background3)]">
            <view class="mb-2 text-3 text-gray-700 font-bold dark:text-[var(--wot-dark-color)]">自定义大小和颜色:</view>
            <view class="text-2.5 text-gray-600 leading-relaxed font-mono dark:text-[var(--wot-dark-color2)]">
    ...
    <demo-block title="图标对比" transparent>
      <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        <view class="mb-4 text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">相同功能图标对比</view>
        <view class="space-y-4">
          <view class="grid grid-cols-2 gap-4">
            <view class="rounded-2 bg-blue-50 p-4 text-center dark:bg-blue-900/20">
              <view class="mb-2 text-3.5 text-blue-700 font-bold dark:text-blue-300">WotUI 图标</view>
            ...
            <view class="rounded-2 bg-green-50 p-4 text-center dark:bg-green-900/20">
              <view class="mb-2 text-3.5 text-green-700 font-bold dark:text-green-300">Iconify 图标</view>
              <view class="mb-3 flex justify-center space-x-4">
      ...
      <view class="space-y-3">
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          <view class="mb-3 flex items-center">
            ...
            <view class="text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">WotUI 图标适用场景</view>
          </view>
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          <view class="mb-3 flex items-center">
            <view class="mr-2 text-6">🎨</view>
            <view class="text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">Iconify 图标适用场景</view>
          </view>
          <view class="text-3 text-gray-600 leading-relaxed space-y-2 dark:text-[var(--wot-dark-color2)]">
            <view>• 需要更多图标选择时</view>
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          <view class="mb-3 flex items-center">
            <view class="mr-2 text-6">🤝</view>
            <view class="text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">结合使用建议</view>
          </view>
          <view class="text-3 text-gray-600 leading-relaxed space-y-2 dark:text-[var(--wot-dark-color2)]">
            <view>
              •
