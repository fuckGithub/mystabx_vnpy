...
<template>
  <div class="login-left-view">
    ...
    <div class="geometric-decorations">
      ...
      <div class="geo-element square-bottom-right animate-fade-in-right" style="animation-delay: 0s"></div>
      ...
      <div class="geo-element dot dot-center-right animate-bounce-in" style="animation-delay: 0s"></div>

      <!-- 叠加方块组 -->
      <div class="squares-group">
        <i class="geo-element square square-blue animate-fade-in-left-rotated-blue" style="animation-delay: 0.2s"></i>
        <i class="geo-element square square-pink animate-fade-in-left-rotated-pink" style="animation-delay: 0.4s"></i>
        <i class="geo-element square square-purple animate-fade-in-left-no-rotation" style="animation-delay: 0.6s"></i>
      </div>
    </div>
  </div>
</template>
...
const webLogoSrc = computed(() => configStore.configData.sys_web_logo?.config_value?.trim() || undefined)

const siteTitle = computed(() => configStore.configData.sys_web_title?.config_value?.trim() || AppEnv.systemInfo.name)
