  ...
  <div class="flex-cb max-md:!block" id="fa-table-header">
    ...
    <div class="flex-c md:justify-end max-md:mt-3 max-sm:!hidden">
      ...
      <ElTooltip
        ...
        <div class="button" @click="search" :class="!showSearchBar ? 'active !bg-theme hover:!bg-theme/80' : ''">
      ...
      <div
        ...
        <FaSvgIcon icon="ri:refresh-line" :class="loading && isManualRefresh ? 'animate-spin text-g-600' : ''" />
      </div>
      ...
      <ElTooltip
        ...
        <div class="button" @click="toggleRowDrag" :class="isRowDrag ? 'active !bg-theme hover:!bg-theme/80' : ''">
            ...
            <VueDraggable
              ...
              <div
                ...
                <div
                  ...
                  <FaSvgIcon :icon="item.fixed ? 'ri:unpin-line' : 'ri:drag-move-2-fill'" class="text-base" />
                </div>
                <ElCheckbox
