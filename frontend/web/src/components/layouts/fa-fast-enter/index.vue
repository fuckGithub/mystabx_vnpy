        ...
        <div class="grid grid-cols-2 gap-1.5">
          ...
          <div
            ...
            <div class="app-icon size-12 flex-cc rounded-lg bg-g-200/80 dark:bg-g-300/30">
              <FaSvgIcon class="text-xl" :icon="application.icon" :style="{ color: application.iconColor }" />
            </div>
            <div>
 ...
 * @param link 外部链接
 */
const handleNavigate = (routeName?: string, link?: string, routeQuery?: Record<string, string>): void => {
