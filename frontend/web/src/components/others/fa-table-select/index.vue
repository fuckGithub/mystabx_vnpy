            ...
            <ElFormItem :label="item.label" :prop="item.prop">
              ...
              <template v-if="item.type === 'input'">
                <template v-if="item.attrs?.type === 'number'">
                  <ElInput v-model.number="queryParams[item.prop]" v-bind="item.attrs" @keyup.enter="handleQuery" />
                </template>
                <template v-else>
                  <ElInput v-model="queryParams[item.prop]" v-bind="item.attrs" @keyup.enter="handleQuery" />
                </template>
              </template>
              <!-- Select 选择器 -->
