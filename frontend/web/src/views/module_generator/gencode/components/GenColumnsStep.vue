<template>
  <div class="elTableCustom">
    ...
    <p class="gencode-columns-tip">菜单与路由、接口路径的对应见「基础配置」第一步中的折叠「对照」表。</p>
    <ElAlert
    ...
    <div class="data-table__content">
      <ElTable
        ...
        <ElTableColumn label="列名" prop="column_name" min-width="60" :show-overflow-tooltip="true" />
        <ElTableColumn label="类型" prop="column_type" min-width="60" :show-overflow-tooltip="true" />
        ...
        <ElTableColumn label="默认值" prop="column_default" min-width="60" :show-overflow-tooltip="true">
          <template #default="scope">
