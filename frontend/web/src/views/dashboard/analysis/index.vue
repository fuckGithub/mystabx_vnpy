    ...
    <ElRow :gutter="20">
      <ElCol :xs="24" :md="12" :lg="8" class="mb-5">
        <div class="fa-card">
          ...
          <FaBarChart :data="singleBarData" :xAxisData="xAxisData" :showLegend="true" legendPosition="right" />
        </div>
      </ElCol>
      <ElCol :xs="24" :md="12" :lg="8" class="mb-5">
        <div class="fa-card">
          ...
          <FaBarChart :data="multiBarData" :xAxisData="xAxisData" :showLegend="true" barWidth="26%" />
        </div>
      </ElCol>
      <ElCol :xs="24" :md="12" :lg="8" class="mb-5">
        <div class="fa-card">
      ...
      <ElCol :xs="24" :md="12" :lg="8" class="mb-5">
        <div class="fa-card">
          ...
          <FaHBarChart :data="[50, 80, 120, 90, 60]" :xAxisData="['产品A', '产品B', '产品C', '产品D', '产品E']" />
        </div>
      </ElCol>
      <ElCol :xs="24" :md="12" :lg="8" class="mb-5">
        <div class="fa-card">
