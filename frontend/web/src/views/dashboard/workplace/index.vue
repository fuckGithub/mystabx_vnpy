  ...
  <div>
    ...
    <div class="console-cards-showcase border-g-200">
      <div class="py-5">
        ...
        <ElRow :gutter="20">
          <ElCol v-for="card in statsCards" :key="`t-${card.id}`" :xs="24" :sm="12" :md="6" class="mb-5">
            <FaStatsCard
              :icon="card.icon"
        ...
        <ElRow :gutter="20">
          <ElCol v-for="card in statsCards" :key="`n-${card.id}`" :xs="24" :sm="12" :md="6" class="mb-5">
            <FaStatsCard
              :icon="card.icon"
              :iconStyle="card.iconStyle"
              :count="card.count"
        ...
        <ElRow :gutter="20">
          <ElCol v-for="card in statsCards" :key="`c-${card.id}`" :xs="24" :sm="12" :md="6" class="mb-5">
            <FaStatsCard
              :icon="card.icon"
        ...
        <ElRow :gutter="20">
          <ElCol v-for="card in progressCards" :key="`p-${card.id}`" :xs="24" :sm="12" :md="6" class="mb-5">
        ...
        <ElRow :gutter="20">
          <ElCol v-for="card in progressCards" :key="`pi-${card.id}`" :xs="24" :sm="12" :md="6" class="mb-5">
            <FaProgressCard
