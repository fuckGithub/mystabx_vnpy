...
import NoticeAPI, { type NoticeForm, type NoticePageQuery, type NoticeTable } from '@/api/module_system/notice'
  ...
  core: {
    ...
    columnsFactory: (): ColumnOption<NoticeTable>[] => [
      ...
      },
      {
        ...
        minWidth: 100,
        formatter: (row: NoticeTable) =>
          h(ElTag, { type: row.notice_type === '1' ? 'primary' : 'warning' }, () => noticeTypeLabel(row.notice_type)),
      },
