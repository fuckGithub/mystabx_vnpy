...
async function handleSubmit() {
  try {
    ...
    if (!valid) return toast.error(errors[0].message)
...
<template>
  <view class="app-container">
    <!-- 背景图 -->
    <wd-img src="/static/images/login-bg.svg" mode="aspectFill" class="login-bg" />
    ...
    <view class="login-card">
      ...
      <!-- 登录表单区域 -->
      <wd-form ref="loginFormRef" :model="loginFormData" class="login-form">
        <wd-cell-group border class="form-group">
          ...
          <view v-if="captchaState.enable" class="captcha">
            ...
            <view v-if="!captchaState.img_base && captchaState.enable" @click="getLoginCaptcha">
              <text>点击加载</text>
            </view>
          </view>
          ...
          <view class="auth-links">
            ...
            <view class="forgot-password">
              <wd-text type="primary" text="忘记密码？" size="24rpx" @click="handleForgotPassword" />
            </view>
          </view>
          ...
          <view class="register-link">
            ...
            <wd-text type="primary" text="注册账号" size="24rpx" @click="handleRegister" />
          </view>

          <!-- 版权信息 -->
          <view class="copyright">
            <wd-text text="Copyright © 2025-2026 service.xxcdjl.xyz 版权所有" size="20rpx" />
          </view>
        </wd-cell-group>
      </wd-form>
    </view>
