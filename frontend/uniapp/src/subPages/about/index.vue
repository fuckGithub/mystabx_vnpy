...
<template>
  <view class="min-h-screen bg-gray-100 py-3 dark:bg-[var(--wot-dark-background)]">
    ...
    <view class="mx-3 mb-3 flex flex-col gap-2">
      <text class="text-6 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">关于我们</text>
    ...
    <demo-block title="关于 uni-helper 团队" transparent>
      <view class="rounded-3 bg-white p-5 dark:bg-[var(--wot-dark-background2)]">
        <text class="mb-3 block text-3.5 text-gray-600 leading-relaxed dark:text-[var(--wot-dark-color2)]">
          ...
          是一个旨在增强 uni-app 系列产品的开发体验为爱发电的非官方组织。作为靠爱发电的非官方项目，uni-helper
    ...
    <demo-block title="更多信息" transparent>
      <wd-cell-group border custom-class="rounded-2! overflow-hidden">
        <wd-cell
          ...
          is-link
          @click="openWeChat" />
        <wd-cell title="捐赠" title-width="200px" label="每一份捐赠都是对我们莫大的鼓励！" is-link @click="donate" />
      </wd-cell-group>
    </demo-block>
  </view>
</template>
