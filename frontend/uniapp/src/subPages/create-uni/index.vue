...
const wotQuickStart = ref({
  ...
  features: ['✅ TypeScript 项目', '✅ 集成 Pinia 状态管理', '✅ 自动配置 WotUI 组件库', '✅ 添加 ESLint 支持'],
})
  ...
  <view class="min-h-screen bg-gray-100 py-3 dark:bg-[var(--wot-dark-background)]">
    ...
    <view class="mx-3 mb-3">
      <view class="rounded-3 bg-white px-5 py-8 text-center dark:bg-[var(--wot-dark-background2)]">
        ...
        <view class="mb-2 text-6 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">CreateUni 脚手架</view>
    ...
    <demo-block title="为什么选择 create-uni？" transparent>
      ...
      <view class="mb-3">
        <view
          ...
          <view class="mb-1 text-3.5 text-red-600 font-bold dark:text-red-400">❌ {{ item.problem }}</view>
    ...
    <demo-block title="快速创建 WotUI 项目" transparent>
      <view class="rounded-3 bg-white p-5 dark:bg-[var(--wot-dark-background2)]">
        ...
        <view>
          <view class="mb-2 text-3.5 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">这个命令会：</view>
          <view
    ...
    <demo-block title="其他使用方式" transparent>
      <view
        ...
        <view
          class="flex items-center justify-between border border-gray-200 rounded-2 bg-gray-50 p-2 dark:border-[var(--wot-dark-border)] dark:bg-[var(--wot-dark-background3)]"
