    ...
    <demo-block title="UnoCSS 核心特性" transparent>
      <view class="grid grid-cols-2 gap-3">
        <view
          ...
          <view
            class="rounded bg-gray-100 px-2 py-1 text-2.5 text-gray-700 font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]">
            {{ feature.example }}
          </view>
        </view>
      </view>
    ...
    <demo-block title="实用工具类" transparent>
      <view class="space-y-4">
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          ...
          <view
            class="rounded bg-gray-100 p-2 text-2.5 text-gray-700 font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]"
