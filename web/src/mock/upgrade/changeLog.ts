...
export const upgradeLogList = ref<UpgradeLog[]>([
  ...
  },
  {
    ...
    detail: [
      ...
      '新增：FaForm 和 FaSearchBar 组件的 label 支持自定义渲染函数，可实现带 tooltip 等复杂标签',
  ...
  },
  {
    ...
    title: '图表组件重构',
    date: '2025-06-22',
    detail: ['重构图表组件，优化代码结构与可维护性', '精细调整图表动画与主题配色方案，提升视觉一致性'],
  },
  {
    version: 'v2.4.2.4',
    title: '组件重构、代码优化',
    date: '2025-06-18',
    detail: ['FaMenuRight 组件重构', 'ArtWatermark 增加类型注释', 'components/core/cards 下面的组件重构，代码优化'],
  },
  {
    version: 'v2.4.2.3',
    title: '组件重构、代码优化',
