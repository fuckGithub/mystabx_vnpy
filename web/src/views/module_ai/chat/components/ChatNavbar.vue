<template>
  <div class="chat-navbar">
    <div class="navbar-left">
      <button class="collapse-btn" @click="toggleSidebar">
        <FaSvgIcon
          ...
          class="size-6" />
        <FaSvgIcon v-else :icon="resolveIconForFaSvgIcon('layout_leftbar_open_line')" class="size-6" />
      </button>
    </div>
    <div class="navbar-right">
      ...
      <ElTag class="connection-status" effect="plain" :type="connectionStatus === 'connected' ? 'success' : 'danger'">
