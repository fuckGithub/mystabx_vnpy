  ...
  <div :class="['message-group', message.type]">
    ...
    <div class="message-content">
      ...
      <div class="message-body">
        ...
        <!-- 思考过程（思维链）折叠展示 -->
        <div v-if="message.type === 'assistant' && message.reasoning" class="reasoning-block">
          <button class="reasoning-toggle" @click="toggleReasoning">
            <ElIcon class="reasoning-icon" :class="{ 'is-expanded': !message.reasoningCollapsed }">
              <ArrowRight />
            </ElIcon>
            <span>思考过程</span>
            <span class="reasoning-badge">已深度思考</span>
          </button>
          <div v-show="!message.reasoningCollapsed" class="reasoning-content">
        ...
        <div v-if="message.type === 'assistant' && message.loading && !message.content" class="typing-indicator">
...
import { ArrowDown, ArrowRight, ArrowUp, ChatDotRound, CopyDocument, Document, User } from '@element-plus/icons-vue'
...
const toggleReasoning = () => {
  props.message.reasoningCollapsed = !props.message.reasoningCollapsed
}
</script>
      ...
      .message-text {
        ...
        &.collapsed {
          ...
          &::after {
            ...
            height: 60px;
            content: '';
            background: linear-gradient(transparent, var(--chat-area-bg, var(--el-bg-color-overlay)));
          }
        }
