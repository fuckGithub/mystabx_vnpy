...
import Demo01API, { type Demo01Form, type Demo01PageQuery, type Demo01Table } from '@/api/module_example/demo01'
    ...
    columnsFactory: (): ColumnOption<Demo01Table>[] => [
      ...
      { prop: 'uuid', label: 'UUID', minWidth: 168, showOverflowTooltip: true },
      {
        ...
        formatter: (row: Demo01Table) => {
          ...
          const cfg = ok ? { type: 'success' as const, text: '正常' } : { type: 'info' as const, text: '停用' }
