...
import ParamsAPI, { type ConfigForm, type ConfigPageQuery, type ConfigTable } from '@/api/module_system/params'
    ...
    columnsFactory: (): ColumnOption<ConfigTable>[] => [
      ...
      { prop: 'config_value', label: '配置值', minWidth: 200, showOverflowTooltip: true },
      {
        ...
        formatter: (row: ConfigTable) =>
          h(ElTag, { type: row.config_type ? 'success' : 'danger' }, () => (row.config_type ? '是' : '否')),
      },
