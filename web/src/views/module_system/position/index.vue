...
function formatPositionOperationCell(row: PositionTable, ctx: Parameters<typeof buildPositionRowActions>[1]) {
  ...
  return h('div', { class: 'inline-flex flex-wrap items-center justify-end gap-1 position-table-actions' }, [
    ...inlineNodes,
    dropdown,
  ])
}
