  ...
  <FaDrawer
    ...
    <div class="drawer-perm-content flex flex-col min-h-0 flex-1 overflow-hidden">
      <ElContainer class="h-full min-h-0 flex-1">
        <!-- 数据权限 -->
        <ElAside>
          <div class="border-r-1 border-r-[var(--el-border-color-lighter)] b-r-solid h-[100%] p-[20px] box-border">
        ...
        <ElMain>
          ...
          <div class="mt-5 max-h-[69vh] b-1 b-solid b-[var(--el-border-color-lighter)] p-10px overflow-auto box-border">
            <ElTree
              ref="permTreeRef"
              node-key="value"
              show-checkbox
