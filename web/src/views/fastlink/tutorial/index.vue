                ...
                <div class="manual-html" @click.capture="handleAnchorClick">
                  <div class="manual-html__inner">
                    ...
                    <ElCard id="toc" shadow="never" class="toc mb-6">
                      ...
                      <ul>
                        <li>
                          <ElLink href="#mod-system" type="primary" :underline="false">一、系统管理</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-user" type="primary" :underline="false">用户管理</ElLink>
                            ·
                            <ElLink href="#page-role" type="primary" :underline="false">角色管理</ElLink>
                            ·
                            <ElLink href="#page-menu" type="primary" :underline="false">菜单管理</ElLink>
                            ·
                            <ElLink href="#page-dept" type="primary" :underline="false">部门管理</ElLink>
                            ·
                            <ElLink href="#page-position" type="primary" :underline="false">岗位管理</ElLink>
                            ·
                            <ElLink href="#page-dict" type="primary" :underline="false">字典管理</ElLink>
                            ·
                            <ElLink href="#page-param" type="primary" :underline="false">参数配置</ElLink>
                            ·
                            <ElLink href="#page-notice" type="primary" :underline="false">通知公告</ElLink>
                            ·
                            <ElLink href="#page-tenant" type="primary" :underline="false">租户管理</ElLink>
                            ·
                            <ElLink href="#page-log" type="primary" :underline="false">操作日志</ElLink>
                            ·
                            <ElLink href="#page-login" type="primary" :underline="false">登录页</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-monitor" type="primary" :underline="false">二、监控管理</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-online" type="primary" :underline="false">在线用户</ElLink>
                            ·
                            <ElLink href="#page-cache" type="primary" :underline="false">缓存管理</ElLink>
                            ·
                            <ElLink href="#page-resource" type="primary" :underline="false">文件管理</ElLink>
                            ·
                            <ElLink href="#page-server" type="primary" :underline="false">服务监控</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-task" type="primary" :underline="false">三、任务管理</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-cronjob" type="primary" :underline="false">调度器监控</ElLink>
                            ·
                            <ElLink href="#page-cronnode" type="primary" :underline="false">节点管理</ElLink>
                            ·
                            <ElLink href="#page-workflow" type="primary" :underline="false">流程编排</ElLink>
                            ·
                            <ElLink href="#page-nodetype" type="primary" :underline="false">编排节点类型</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-ai" type="primary" :underline="false">四、AI 模块</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-ai-chat" type="primary" :underline="false">AI智能助手</ElLink>
                            ·
                            <ElLink href="#page-ai-fachat" type="primary" :underline="false">会话聊天</ElLink>
                            ·
                            <ElLink href="#page-ai-memory" type="primary" :underline="false">会话记忆</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-generator" type="primary" :underline="false">五、代码生成器</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-gencode" type="primary" :underline="false">代码生成</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-app" type="primary" :underline="false">六、应用管理</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-portal" type="primary" :underline="false">插件市场</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-example" type="primary" :underline="false">七、示例模块</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-demo" type="primary" :underline="false">示例管理</ElLink>
                            ·
                            <ElLink href="#page-demo01" type="primary" :underline="false">三级菜单</ElLink>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="toc-l2">
                            ...
                            ·
                            <ElLink href="#page-changelog" type="primary" :underline="false">更新日志</ElLink>
                            ·
                            <ElLink href="#page-db-workplace" type="primary" :underline="false">工作台</ElLink>
                            ·
                            <ElLink href="#page-db-console" type="primary" :underline="false">控制台</ElLink>
                            ·
                            <ElLink href="#page-db-analysis" type="primary" :underline="false">分析页</ElLink>
                            ·
                            <ElLink href="#page-db-ecommerce" type="primary" :underline="false">电子商务</ElLink>
                            ·
                            <ElLink href="#page-db-map" type="primary" :underline="false">地图</ElLink>
                            ·
                            <ElLink href="#page-db-pricing" type="primary" :underline="false">定价</ElLink>
                            ·
                            <ElLink href="#page-db-article" type="primary" :underline="false">文章管理</ElLink>
                            ·
                            <ElLink href="#page-db-tutorial" type="primary" :underline="false">教程</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-layout" type="primary" :underline="false">九、布局与通用功能</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#layout-main" type="primary" :underline="false">主布局</ElLink>
                            ·
                            <ElLink href="#layout-sidebar" type="primary" :underline="false">侧栏菜单</ElLink>
                            ·
                            <ElLink href="#layout-header" type="primary" :underline="false">顶栏</ElLink>
                            ·
                            <ElLink href="#layout-worktab" type="primary" :underline="false">标签页</ElLink>
                            ·
                            <ElLink href="#layout-settings" type="primary" :underline="false">设置面板</ElLink>
                            ·
                            <ElLink href="#layout-notification" type="primary" :underline="false">通知</ElLink>
                            ·
                            <ElLink href="#layout-search" type="primary" :underline="false">全局搜索</ElLink>
                            ·
                            <ElLink href="#layout-lock" type="primary" :underline="false">锁屏</ElLink>
                            ·
                            <ElLink href="#layout-user" type="primary" :underline="false">用户菜单</ElLink>
                            ·
                            <ElLink href="#layout-theme" type="primary" :underline="false">主题切换</ElLink>
                            ·
                            <ElLink href="#layout-lang" type="primary" :underline="false">语言切换</ElLink>
                          </div>
                        </li>
                        <li>
                          <ElLink href="#mod-exception" type="primary" :underline="false">十、异常页</ElLink>
                          <div class="toc-l2">
                        ...
                        <li>
                          <ElLink href="#mod-swagger" type="primary" :underline="false">十一、接口文档（API）</ElLink>
                          <div class="toc-l2">
                            <ElLink href="#page-swagger" type="primary" :underline="false">Swagger文档</ElLink>
                            ·
                            <ElLink href="#page-redoc" type="primary" :underline="false">Redoc文档</ElLink>
                            ·
                            <ElLink href="#page-ljdoc" type="primary" :underline="false">LangJin文档</ElLink>
                          </div>
                        </li>
                      </ul>
                    </ElCard>
                    ...
                    <div class="module" id="mod-system">
                      <h2>
                        一、系统管理
                        <ElTag type="primary" effect="dark" size="small" class="shrink-0">module_system</ElTag>
                      </h2>
                      ...
                      <div class="page" id="page-user">
                        ...
                        <div class="section">
                          ...
                          <p>
                            ...
                            — 含
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">create</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">delete</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">update</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">detail</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">import</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">export</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">patch</ElTag>
                          </p>
                        </div>

                        <div class="section">
                          <ElDivider content-position="left" class="my-3!">🔍 搜索/筛选表单（5字段）</ElDivider>
                        ...
                        <div class="section">
                          ...
                          <ElSpace wrap size="small" class="mb-2">
                            <ElButton type="primary" size="small" plain class="manual-doc-btn">新增</ElButton>
                            <ElButton type="success" size="small" plain class="manual-doc-btn">导入</ElButton>
                            <ElButton type="warning" size="small" plain class="manual-doc-btn">导出</ElButton>
                            <ElButton type="danger" size="small" plain class="manual-doc-btn">删除</ElButton>
                            <ElButton type="info" size="small" plain class="manual-doc-btn">更多(批量启/停用)</ElButton>
                        ...
                        <div class="section">
                          ...
                          <ElSpace wrap size="small" class="mb-2">
                            <ElButton type="warning" size="small" plain class="manual-doc-btn">重置密码</ElButton>
                            <ElButton type="info" size="small" plain class="manual-doc-btn">详情</ElButton>
                            <ElButton type="primary" size="small" plain class="manual-doc-btn">编辑</ElButton>
                            <ElButton type="danger" size="small" plain class="manual-doc-btn">删除</ElButton>
                          </ElSpace>
                        </div>
                      ...
                      <div class="page" id="page-role">
                        ...
                        <div class="section">
                          ...
                          <p>
                            ...
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">export</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">patch</ElTag>
                            <ElTag effect="plain" type="info" size="small" class="mr-1 font-mono">permission</ElTag>
                          </p>
                        </div>

                        <div class="section">
                          <ElDivider content-position="left" class="my-3!">🔍 搜索表单（3字段）</ElDivider>
                          <ElCard shadow="never" class="mb-3 overflow-x-auto">
                            <table class="manual-doc-table w-full border-collapse text-sm">
                              <thead>
                                <tr><th>类型</th></tr>
                        ...
                        <div class="section">
                          <ElDivider content-position="left" class="my-3!">🔘 行操作按钮</ElDivider>
                          <ElSpace wrap size="small" class="mb-2">
                            <ElButton type="info" size="small" plain class="manual-doc-btn">权限</ElButton>
                            <ElButton type="primary" size="small" plain class="manual-doc-btn">编辑</ElButton>
                            <ElButton type="danger" size="small" plain class="manual-doc-btn">删除</ElButton>
                          </ElSpace>
                        </div>
                        ...
                        <div class="section">
                          ...
                          <ul class="feature-list">
                            <li>
                              <strong>新增/编辑 Drawer</strong>
                              (450px) — 名称、标识(编辑时禁用)、排序、状态(Radio)、权限树(ElTree, 勾选)、备注(textarea)
                            </li>
                            <li>
                      ...
                      <div v-for="p in manualSystemTailPages" :key="p.anchor" class="page" :id="p.anchor">
                        <h3>
                          {{ p.title }}
                          <ElText tag="span" size="small" type="info" class="path font-mono">
                            {{ p.path }}
                        ...
                        <div class="section">
                          <ElDivider content-position="left" class="my-3!">功能完整性验收</ElDivider>
                          <ul class="feature-list">
                    ...
                    <!-- 二～十一：其余业务模块 -->
                    <div v-for="mod in manualModulesAfterSystem" :key="mod.anchor" class="module" :id="mod.anchor">
                      <h2>
                        {{ mod.heading }}
                        <ElTag v-if="mod.pkgTag" type="primary" effect="dark" size="small" class="shrink-0">
                          {{ mod.pkgTag }}
                        </ElTag>
                      </h2>
...
const VIDEO_CONFIG = {
  ...
  DEFAULT_URL: '//lf3-static.bytednsdoc.com/obj/eden-cn/nupenuvpxnuvo/xgplayer_doc/xgplayer-demo.mp4',
  /** 播放器 ID */
