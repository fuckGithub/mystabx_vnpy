  ...
  <ElForm
    ...
    <ElFormItem label="秒" prop="second" class="form-item">
      <ElSelect v-model="crontabValueObj.second" placeholder="秒" clearable>
        ...
        <ElOption v-for="second in seconds" :key="second" :label="second" :value="second.toString()">
          {{ second }}
        </ElOption>
      </ElSelect>
    </ElFormItem>
    ...
    <ElFormItem label="周" prop="week" class="form-item">
      <ElSelect v-model="crontabValueObj.week" placeholder="周" clearable>
        ...
        <ElOption v-for="week in weekOptions" :key="week.value" :label="week.label" :value="week.value">
          {{ week.label }}
        </ElOption>
      </ElSelect>
    </ElFormItem>
