...
<template>
  ...
  <ElIcon v-else-if="elementComponent" :class="iconClass" :style="mergedStyle" class="menu-route-icon">
...
import { elementMenuIconToEpIconify, isElementPlusStoredIcon, resolveElementPlusIconComponent } from '@utils/menuIcon'
...
const iconClass = computed(() => (props.class === false || props.class == null ? undefined : props.class))
