<!-- 统计卡片 -->
<template>
  <div class="fa-card h-32 flex-c px-5 transition-transform duration-200 hover:-translate-y-0.5" :class="boxStyle">
    ...
    <div class="flex-1">
      ...
      <FaCountTo
        ...
        :decimals="decimals"
        :separator="separator" />
      <p class="mt-1 text-sm text-g-500 opacity-90" :style="{ color: textColor }" v-if="description">
        {{ description }}
      </p>
    </div>
    <div v-if="showArrow">
