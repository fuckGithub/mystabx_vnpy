...
export function useSettingsHandlers() {
  ...
  const basicHandlers = {
    ...
    fullscreenTool: () => settingStore.updateSetting('showFullscreen', !settingStore.showFullscreen),
    layoutSizeTool: () => settingStore.updateSetting('showSizeSelect', !settingStore.showSizeSelect),
    notificationTool: () => settingStore.updateSetting('showNotification', !settingStore.showNotification),
