...
from app.utils.sm_crypto_util import Sm4CbcTypeHandler

if TYPE_CHECKING:
    from app.plugin.module_system.dept.model import DeptModel
    from app.plugin.module_system.position.model import PositionModel
...
class UserModel(ModelMixin, TenantMixin, UserMixin):
    ...
    created_by: Mapped[UserModel | None] = relationship(  # type: ignore[override]
        "UserModel",
    ...
    updated_by: Mapped[UserModel | None] = relationship(  # type: ignore[override]
        "UserModel",
