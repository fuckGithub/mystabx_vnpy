...
class OperationLogCreateSchema(BaseModel):
    ...
    signature: str | None = Field(default=None, description="SM2签名值")
    signed_fields: str | None = Field(default=None, description="被签名字段标识")
    ...
    username: str | None = Field(default=None, max_length=64, description="操作人账号")
    mobile: str | None = Field(default=None, max_length=11, description="操作人手机号")
    login_platform: str | None = Field(default=None, max_length=32, description="登录平台")
...
class OperationLogQueryParam:
    ...
    def __init__(
        ...
        mobile: str | None = Query(None, description="操作人手机号"),
        login_platform: str | None = Query(None, description="登录平台"),
    ) -> None:
        # 模糊查询字段
        ...
        # 精确查询字段
        if login_platform:
            self.login_platform = (QueueEnum.eq.value, login_platform)
